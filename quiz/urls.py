...
urlpatterns = [
    ...
    url(regex=r'^category/$', view=CategoriesListView.as_view(),
        name='quiz_category_list_all'),
    #url(regex=r'^create/$', view=QuizListView.as_view(), name='quiz_create'),
    ...
    url(regex=r'^(?P<slug>[\w-]+)/$',
        view=QuizDetailView.as_view(), name='quiz_start_page'),
